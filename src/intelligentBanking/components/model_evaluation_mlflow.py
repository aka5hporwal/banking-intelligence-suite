...
from intelligentBanking.utils.common import save_json
from intelligentBanking.entity.config_entity import EvaluationConfig
...
class Evaluation:
    ...
    @staticmethod
    def load_model(path: Path) -> tensorflow.keras.Model:
